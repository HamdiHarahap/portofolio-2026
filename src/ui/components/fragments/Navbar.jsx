...
const Navbar = () => {
	...
	return (
		...
		>
			<div className="px-36 py-4 flex justify-between items-end">
				<a
					href="#"
					className="bg-linear-to-r from-emerald-400 to-teal-500 bg-clip-text text-transparent font-bold text-lg"
				>
					Hamdi Harahap
				</a>

				<ul className="flex gap-8 text-gray-300 text-sm font-semibold">
