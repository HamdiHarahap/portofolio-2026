	...
	return (
		...
		>
			<div className="relative">
				...
				<div className="absolute w-140 h-16 bg-linear-to-r from-emerald-400 to-teal-500 blur-3xl opacity-30 rounded-full -bottom-5  -left-10 "></div>
				<h1 className="text-6xl font-bold tracking-wide z-40 relative">
					Hello, I'm <br />{' '}
			...
			<div className="relative w-fit">
				...
				<div className="relative flex items-center gap-2 ps-6 pe-32 py-4 rounded-2xl bg-black/40 backdrop-blur-xl border border-white/10 text-gray-20 font-medium italic">
